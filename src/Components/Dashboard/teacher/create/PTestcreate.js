...
{(selectedStandard && selectedSubject) && <button
      ...
      {questions.map((q, index) => (
        <div key={index} className="p-5 border-b border-gray-300">
          ...
          />
            ...
            className="block w-full mt-2 p-2 border border-gray-300 rounded"
          >
            <option value="">{q.topicId ? "Already Link" :"Select Chapter"}</option>
            {q.availableChapters &&
         ...
         <select
            ...
            className="block w-full mt-2 p-2 border border-gray-300 rounded"
          >
            <option value="">{q.topicId ? "Already Link" :"Select Topic"}</option>
            {q.topics &&
              q.topics.map((topic) => (
